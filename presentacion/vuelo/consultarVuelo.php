                                                    ...
                                                    <form method='POST' action='modificarVuelo.php'>
                                                        <div class='modal-body'>
                                                            ...
                                                            <div class='row g-3'>
                                                                ...
                                                                <div class='col-md-6'>
                                                                    <label>Piloto</label>
                                                                    <?php echo "<input class='form-control' name='piloto' value='{$v->getPiloto()}'>" ?>
                                                                </div>

                                                                <div class='col-md-6'>
                                                                    <label>Copiloto</label>
                                                                    <?php echo "<input class='form-control' name='copiloto' value='{$v->getCopiloto()}'>"?>
                                                                </div>
                                                                ...
                                                                <div class='col-md-6'>
                                                                    <label>Hora</label>
                                                                    <?php echo "<input type='time' class='form-control' name='hora' value='{$v->getHora()}'>"?>
                                                                </div>

                                                                <div class='col-md-6'>
                                                                    <label>Fecha</label>
                                                                    <?php echo "<input type='date' class='form-control' name='fecha' value='{$v->getFecha()}'>"?>
                                                                </div>
