                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-control" name="estado">
                                                                <option value="Programado" <?= $v->getEstado() == "Programado" ? "selected" : "" ?>>Programado</option>
                                                                <option value="En curso" <?= $v->getEstado() == "En curso" ? "selected" : "" ?>>En curso</option>
                                                                <option value="Finalizado" <?= $v->getEstado() == "Finalizado" ? "selected" : "" ?>>Finalizado</option>
                                                            </select>
                                                        </div>
